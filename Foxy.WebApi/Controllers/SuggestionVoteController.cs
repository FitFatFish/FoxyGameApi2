...
public class SuggestionVoteController(SuggestionVoteService service, IMapper mapper) : Controller
{
    [HttpGet]
    ...
    public async Task<IActionResult> Get(Guid id)
    {
        ...
        var result = mapper.Map<SuggestionVoteResDto>(item);
        return Ok(result);
    }
    ...
    public async Task<IActionResult> Create(SuggestionVoteReqDto reqentity)
    {
        ...
        var entity = mapper.Map<SuggestionVote>(reqentity);
